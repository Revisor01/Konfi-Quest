...
- Handbuch: Das Einladen von Konfis per QR-Code oder Einladungscode ist jetzt
  vollständig beschrieben — vom Erzeugen über Gültigkeit und Verlängern bis zur
  Selbstregistrierung und den häufigsten Fehlermeldungen. Aus den Kapiteln für
  Konfis und Leitung wird dorthin verwiesen, ebenso zum Check-in per QR-Code.
...
- Handbuch: Nummerierte Schritt-für-Schritt-Listen wurden als ein
  zusammengezogener Absatz angezeigt („… öffnen 2. Die Person antippen …“).
