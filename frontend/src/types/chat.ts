...
export interface ChatRoomBase {
  ...
  /**
   * Ungelesen-Zaehler, wie ihn die Raumliste (GET /chat/rooms) mitliefert.
   *
   * GET /chat/rooms/:roomId liefert ihn NICHT — dort ist das Feld immer
   * undefined. Der Chatraum nutzt es nur als Rueckfallebene, wenn der
   * Badge-Context noch keine Zahl hat.
   */
  unread_count?: number;
}
