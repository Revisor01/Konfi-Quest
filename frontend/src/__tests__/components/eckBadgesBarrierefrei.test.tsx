...
describe('Eck-Badges mit Symbol sind fuer Vorlesehilfen beschriftet', () => {
  it('der Scanner findet die Symbol-Badges (Zaehler)', () => {
    // 26.09.2026: 40 Symbol-Badges in 30 Komponenten (34 nachgezogen, 6 hatten
    // die Beschriftung schon). Wer ein Badge hinzufuegt oder entfernt, zieht
    // die Zahl nach -- sie stellt sicher, dass der Scanner nicht ins Leere
    // laeuft und die Pruefungen darunter still gruen werden.
