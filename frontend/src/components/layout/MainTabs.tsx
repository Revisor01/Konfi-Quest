...
import ChatSplitPage from '../chat/pages/ChatSplitPage';
    ...
    <ModalProvider>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route exact path="/admin/chat" component={ChatSplitPage} />
    ...
    <ModalProvider>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route exact path="/teamer/chat" component={ChatSplitPage} />
    ...
    <ModalProvider>
      <IonTabs>
        <IonRouterOutlet>
          ...
          {/* CHAT ROUTEN - Nach Konfis-Pattern */}
          <Route exact path="/konfi/chat" component={ChatSplitPage} />
