...
export { formatEventDate, formatEventTime, formatEventDateLong, eventEnde, istVergangen, kategorienText, zeigtPunkteart, punkteartText, aktuelleTermine, zuVerbuchendeTermine, vergangeneTermine } from './eventFormatting';
