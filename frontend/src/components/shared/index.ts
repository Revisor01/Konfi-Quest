...
export { formatEventDate, formatEventTime, formatEventDateLong, eventEnde, istVergangen, kategorienText, zeigtPunkteart, punkteartText, istAbgesagt, streichtDurch, titelDekoration, abgesagteAnsEnde, aktuelleTermine, zuVerbuchendeTermine, vergangeneTermine } from './eventFormatting';
