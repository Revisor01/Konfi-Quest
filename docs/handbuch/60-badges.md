...
Der Wert muss in **beiden** Bereichen einzeln erreicht sein; beide müssen im
Jahrgang eingeschaltet sein.
...
Die **Summe** aller vergebenen [Bonuspunkte](40-punkte.md#ueber-bonuspunkte)
erreicht den Wert.

*Beispiel:* Wert 5 → sobald du insgesamt 5 Bonuspunkte vergeben hast, egal ob
auf einmal oder in fünf Schritten.
...
der größer ist als die Zahl der angekreuzten Kategorien, ebenfalls („Der Wert
...
**Lücken sind erlaubt:** Wer 2024 und 2026 aktiv war, aber 2025 nicht, hat
zwei Jahre. Gezählt wird ab dem Eintrittsdatum („Teamer:in seit"). Fehlt das,
zählt das Jahr der ältesten Teamer-Aktivität; fehlt auch das, zählt es null.
