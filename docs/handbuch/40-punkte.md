---
titel: Punkte, Level und Ziele
untertitel: Wie Punkte entstehen, zählen und wieder verschwinden
farbe: "#047857"
gruppe: Nachschlagen
---
...
- **Gottesdienst-Punkte** — für alles rund um Gottesdienste
- **Gemeinde-Punkte** — für alles andere in der Gemeinde

Jeder Konfi hat für beide Arten einen eigenen Zähler. Diese beiden Zähler sind
...
- War der Antrag genehmigt, werden die **Punkte wieder abgezogen** und die
  Gutschrift entfernt.
- Dein **Kommentar wird gelöscht** — der Antrag steht wieder da wie neu.
