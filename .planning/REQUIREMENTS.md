...
- [ ] **INF-02**: createTestApp Helper erstellt Test-Express-App mit echtem pg-Pool gegen Test-DB
- [ ] **INF-03**: Test-DB Lifecycle: Setup, Migration, Seed, Teardown pro Test-Suite
- [ ] **INF-04**: Auth-Test-Helpers generieren echte JWTs fuer alle 5 RBAC-Rollen
- [ ] **INF-05**: Seed-Fixtures fuer 2+ Organisationen, alle Rollen, Beispieldaten
