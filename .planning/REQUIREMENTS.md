...
- [x] **ADM-01**: KonfiPage/KonfiListView nutzt SectionHeader, ListSection und die Konfi-Farblogiken -- visuell konsistent mit dem Konfi-Bereich
...
- [x] **ADM-04**: BadgesPage folgt dem kompakten Header-Pattern mit Stats-Row und einheitlichen Listen-Items
- [x] **ADM-05**: JahrgaengePage folgt dem kompakten Header-Pattern mit Stats-Row und einheitlichen Listen-Items
...
| ADM-01 | Phase 3 (SectionHeader/ListSection) + Phase 4 (CSS-Bereinigung) | Complete |
| ADM-02 | Phase 4 | Complete |
| ADM-03 | Phase 4 | Complete |
| ADM-04 | Phase 3 (SectionHeader/ListSection) + Phase 4 (CSS-Bereinigung) | Complete |
| ADM-05 | Phase 3 (SectionHeader/ListSection) + Phase 4 (CSS-Bereinigung) | Complete |
