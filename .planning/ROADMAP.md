...
Plans:
- [ ] 116-01-PLAN.md (Wave 1) — Backend-Wertung: mandatory_event_count (neuer Typ + Case) + teamer_year-Startjahr auf teamer_since (badges.js)
- [ ] 116-02-PLAN.md (Wave 1) — Prozent-Bug-Fix: fehlende Progress-Cases + Extra-Feld-Mismatch (konfi.js) + teamer_year-Progress Startjahr (teamer.js)
- [ ] 116-03-PLAN.md (Wave 1) — Frontend: mandatory_event_count im Badge-Modal freischalten (Konfi-only, Label, Farbe)
