...
app.use('/api/konfi', konfiRoutes(db, rbacVerifier));
app.use('/api/chat', chatRoutes(db, rbacVerifier, uploadsDir));
app.use('/api/statistics', statisticsRoutes(db, rbacVerifier));
